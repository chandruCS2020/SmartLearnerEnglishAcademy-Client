...
export const PhonicsLevel = [
    {
        id:1,
        name:"Silver",
        description:"This is a reading program inspired by Jolly Phonics, the multi-sensory, step-by-step, child-friendly synthetic phonics methodology. Our SILVER course helps the children decode the complicated English alphabetic code though songs, actions and brilliantly illustrated stories for children aged between 4 to 7 years who are learning to read words and sentences. ",
        level:"Phonics",
        courses : [
            {id:1,name:"silver",list:"Learning 42 letter sounds"},
            {id:2,name:"silver",list:"Learning letter formation"},
            {id:3,name:"silver",list:"Blending (reading of words)"},
            {id:4,name:"silver",list:"Segmenting ( identifying sounds in words)"},
            {id:5,name:"silver",list:"Tricky words or irregular words"},
            {id:6,name:"silver",list:"Building vocabulary"},
            {id:7,name:"silver",list:"Songs, actions and stories for 42 sounds"},
            {id:8,name:"silver",list:"Short and long vowels"},
            {id:9,name:"silver",list:"Sentence reading"},
            {id:10,name:"silver",list:"Fun-filled activities to support learning"},
            {id:11,name:"silver",list:"Spelling test"},
            {id:12,name:"silver",list:"Reading decodable story books"}
        ]
    },
    {
        id:2,
        ...
        courses : [
            ...
            {id:2,name:"gold",list:"Learning alternative spellings"},
            {id:3,name:"gold",list:"Spelling test"},
            {id:4,name:"gold",list:"Picture comprehension and guided writing on topics"},
            {id:5,name:"gold",list:"Developing story telling ability"},
            {id:6,name:"gold",list:"Reading decodable story books with alternative spellings"},
        ]
    ...
    },
    {
        ...
        courses : [ 
            ...
            {id:2,name:"diamond",list:"Spelling rules"},
            {id:3,name:"diamond",list:"Silent letters"},
            {id:4,name:"diamond",list:"Advanced alphabetic code"},
            {id:5,name:"diamond",list:"Independent writing on topics"},
            {id:6,name:"diamond",list:"Learn to use dictionary"},
            {id:7,name:"diamond",list:"Trigraphs"},
            {id:8,name:"diamond",list:"Nurture the love for reading through exposure to books of International authors"},
            {id:9,name:"diamond",list:"Write simple, grammatically correct sentences"},
        ]
        
    }
]
// export const PhonicsSilver = [
//     {id:1,name:"silver",list:"Learning 42 letter sounds"},
//     {id:2,name:"silver",list:"Learning letter formation"},
//     {id:3,name:"silver",list:"Blending (reading of words)"},
//     {id:4,name:"silver",list:"Segmenting ( identifying sounds in words)"},
